...
******************************************************************************/
static void LCD_1IN44_SendCommand(uint8_t Reg)
{
...
parameter:
    Data : Write data
******************************************************************************/
static void LCD_1IN44_SendData_8Bit(uint8_t Data)
{
...
parameter:
    Data : Write data
******************************************************************************/
static void LCD_1IN44_SendData_16Bit(uint16_t Data)
{
    DEV_Digital_Write(LCD_DC_PIN, 1);
    DEV_Digital_Write(LCD_CS_PIN, 0);
...
********************************************************************************/
static void LCD_1IN44_SetAttributes(uint8_t Scan_dir)
{
...
********************************************************************************/
void LCD_1IN44_SetWindows(uint16_t Xstart, uint16_t Ystart, uint16_t Xend, uint16_t Yend)
{
    uint8_t x,y;
...
parameter:
******************************************************************************/
void LCD_1IN44_Clear(uint16_t Color)
{
    uint16_t j,i;
    uint16_t Image[LCD_1IN44.WIDTH*LCD_1IN44.HEIGHT];
    ...
    for(j = 0; j < LCD_1IN44.HEIGHT; j++){
        DEV_SPI_Write_nByte(LCD_SPI_PORT,(uint8_t *)&Image[j*LCD_1IN44.WIDTH], LCD_1IN44.WIDTH*2);
...
parameter:
******************************************************************************/
void LCD_1IN44_Display(uint16_t *Image)
{
    uint16_t j;
    LCD_1IN44_SetWindows(0, 0, LCD_1IN44.WIDTH, LCD_1IN44.HEIGHT);
    DEV_Digital_Write(LCD_DC_PIN, 1);
...
void LCD_1IN44_DisplayWindows(uint16_t Xstart, uint16_t Ystart, uint16_t Xend, uint16_t Yend, uint16_t *Image)
{
    // display
    uint32_t Addr = 0;
...
void LCD_1IN44_DisplayPoint(uint16_t X, uint16_t Y, uint16_t Color)
{
