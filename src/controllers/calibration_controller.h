...
//     void renderMainPage(lv_obj_t* parent);
//     void renderSensorCalibrationPage(lv_obj_t* parent);
//     void renderThermalCalibrationPage(lv_obj_t* parent);
//     void renderDoorCalibrationPage(lv_obj_t* parent);
//     void renderSummaryPage(lv_obj_t* parent);
//     void updateMenuButtonFocus();
